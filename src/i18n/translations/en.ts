export const en = {
  ...
  about: {
    ...
    bio: [
      ...
      "Throughout my professional work, I have handled a wide range of matters across intellectual property, internet law, and commercial practice, including ongoing legal advisory, contract drafting, and dispute-related work. My approach combines legal precision with a practical business perspective, aiming to provide clear, actionable solutions tailored to each client's needs.",
    ],
    approachBadge: "Approach",
    approachHeading: "How I Work",
    approachItems: [
      {
        title: "Direct, Precise, and Transparent",
        desc: "I believe in direct, precise, and transparent legal counsel — grounded not only in legal analysis, but in a deep understanding of business realities.",
      },
      {
        title: "Full Assessment",
        desc: "Each matter is approached by evaluating legal exposure, commercial impact, and available strategic options — to enable informed decision-making.",
      },
      {
        title: "Protecting Your Interests",
        desc: "The objective is to reduce risk and protect long-term interests — whether building a brand, developing a product, managing rights, or handling a dispute.",
      },
    ],
    qualBadge: "Core Areas",
    qualHeading: "Core Areas of Practice",
    milestones: [
      { title: "Intellectual Property", desc: "Protection, strategy, and commercialization of rights." },
      { title: "Trademarks", desc: "Clearance, registration, and enforcement." },
      { title: "Copyright", desc: "Digital content, usage rights, and infringement." },
      { title: "Technology & Internet Law", desc: "Terms of use, privacy, and agreements." },
      { title: "Artificial Intelligence", desc: "Legal risks, ownership, and contracting." },
      { title: "Commercial Litigation", desc: "Dispute strategy and representation." },
    ],
  },
  ...
  contact: {
    badge: "Get in Touch",
    h1: "Contact Us",
    sub: "Whether you need counsel on intellectual property, technology law, or a commercial dispute, we're here to help. Reach out to schedule a consultation or send a confidential inquiry.",
