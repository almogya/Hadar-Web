    ...
    <Layout>
      ...
      <section className="relative flex items-center justify-center overflow-hidden" style={{ minHeight: "100svh" }}>
        ...
        <div className="relative z-10 w-full text-center px-6 py-40 md:py-48" style={{ transform: "translateY(12vh)" }}>
          ...
          {t.hero.h1 && (
            <h1 dir={lang === "he" ? "rtl" : "ltr"} className="text-white font-bold mb-6 mx-auto" style={{ fontFamily: lang === "he" ? '"Heebo", sans-serif' : '"Playfair Display", Georgia, serif', fontSize: "clamp(2rem, 4.5vw, 4rem)", lineHeight: 1.1, maxWidth: "820px", whiteSpace: "pre-line" }}>
                ...
                return (
                  <div key={id} className="group relative flex flex-col items-center text-center">
                    <div
                      ...
                      style={{ animation: `ring-pulse 2.4s ease-out ${i * 3}s infinite` }}
                    >
