            ...
            return (
              <>
                ...
                <h1
                  ...
                  className="mx-auto"
                  style={{ fontFamily: '"Playfair Display", Georgia, serif', fontWeight: 700, fontSize: "clamp(2.2rem, 5.5vw, 4.5rem)", lineHeight: 1.1, letterSpacing: "0.06em", color: "#C9A227", transform: "translateX(0.5em)" }}
                >
                ...
                >
                  {["IP.", "INTERNET.", "DEFAMATION."].map((w, i) => (
                    <span
                      key={w}
