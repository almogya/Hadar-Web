  ...
  return (
    <Layout>
      ...
      <section className="relative flex items-center justify-center overflow-hidden" style={{ minHeight: "100svh" }}>
        <img src={heroNightImg} alt="" className="absolute inset-0 w-full h-full object-cover" style={{ objectPosition: "45% 50%" }} aria-hidden="true" />
        ...
        <div className="relative z-10 w-full text-center px-6 py-40 md:py-48">
          ...
          {lang === "he" && (
            <p className="mt-8 mx-auto max-w-xl text-[11px] leading-relaxed" style={{ color: "rgba(255,255,255,0.28)" }}>
              השימוש בכלי בינה מלאכותית נעשה ככלי עזר בלבד, ואינו מחליף ייעוץ משפטי, בדיקה מקצועית, שיקול דעת אנושי או אחריות מקצועית של עורך הדין המטפל. השימוש כאמור אינו גורע מחיסיון עו״ד–לקוח.
            </p>
          )}
        </div>
      </section>
