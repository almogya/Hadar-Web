  ...
  return (
    <Layout>
      ...
      <section className="relative h-[94svh] md:h-[94vh] overflow-hidden">
        ...
        <img src={officeImg} alt="" className="absolute inset-0 w-full h-full object-cover md:object-center object-[40%_center] md:scale-100 scale-125" style={{ transformOrigin: "40% center" }} aria-hidden="true" />
        {/* Dark overlay */}
        ...
        <div className="md:hidden absolute top-[28%] left-0 right-0 z-10">
          {(lang === "he"
            ? [
                { label: "לשון הרע",    desc: "הגשת תביעות לשון הרע",       pos: "83%" },
