        ...
        <div className="container flex items-center justify-between h-20">
          ...
          <Link to={localePath("/")} className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold text-foreground leading-tight" style={{ fontFamily: '"Playfair Display", Georgia, serif', letterSpacing: "0.25cm" }}>
                HY Law Offices
              </span>
              <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-medium">
                {lang === "he" ? "קניין רוחני, אינטרנט ולשון הרע" : "IP · Internet · Defamation"}
              </span>
            </div>
          </Link>
