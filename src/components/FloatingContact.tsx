...
const FloatingContact = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 end-6 z-40 w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg flex items-center justify-center hover:bg-[#20bd5a] transition-all duration-300 hover:scale-105"
    >
